...
import DelbinGeorgeII from '../assets/images/DelbinGeorgeII.png'
...
function Hero() {
     ...
     return (
          <div className={`flex md:flex-row space-y-4 md:space-y-0 flex-col md:justify-between ${(mode == "light") ? (' bg-light-mode-primary text-dark-mode-primary') : ('bg-dark-mode-primary text-light-mode-primary')}`}>
               <div className={`py-6 md:py-8 rounded-3xl pl-4 md:pl-8 w-full md:w-[74%] flex flex-col items-start justify-between ${mode == "light" ? 'bg-light-mode-secondary' : 'bg-dark-mode-secondary'}`}>
                    ...
                    <div className='flex items-center space-x-5 md:space-x-7'>
                         <Link to="resume"
                              className={`py-2 md:py-3 px-5 md:px-6 font-inter rounded-lg hover:cursor-pointer ${(mode == 'light') ? ('bg-dark-mode-primary text-light-mode-primary ') : ('bg-light-mode-primary text-dark-mode-primary')}`}>
                              View Resume
                         </Link>
