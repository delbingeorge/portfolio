...
import { faBehance, faGithub, faLinkedin, faSpotify, faTwitch, faTwitter, faTypo3, faYoutube } from '@fortawesome/free-brands-svg-icons';
     ...
     return (
          <div className={`${(mode == "light") ? ('bg-light-mode-primary text-dark-mode-primary') : ('bg-dark-mode-primary text-light-mode-primary')}`}>
               ...
               <div className='grid grid-cols-3 md:grid-cols-5 grid-rows-2 gap-4'>
                    ...
                    <a href='https://monkeytype.com/profile/delbingeorge' aria-label="Spotify" className={`skill-card ${mode == "light" ? 'bg-light-mode-secondary' : 'bg-dark-mode-secondary'}`}>
                         <svg width={60} xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-680 -1030 300 180">
                              <g>
