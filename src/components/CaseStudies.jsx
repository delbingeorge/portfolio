     ...
     return (
          <div className={`${(mode == "light") ? ('bg-light-mode-primary text-dark-mode-primary') : ('bg-dark-mode-primary text-light-mode-primary')}`}>
               ...
               <div className='grid grid-cols-1 md:grid-cols-2 gap-3 '>
                    <Link to='/case-study/eatables' onClick={() => { setID(0) }} className={`group flex items-center justify-center hover:bg-eatables card py-8 ${(mode == "light") ? ('bg-light-mode-secondary text-dark-mode-secondary') : ('bg-dark-mode-secondary text-light-mode-primary')}`}>
                    ...
                    <Link to="/case-study/qikfixer" onClick={() => { setID(1) }} className={`group flex items-center justify-center hover:bg-qikfixer card py-8 ${(mode == "light") ? (' bg-light-mode-secondary text-dark-mode-secondary') : ('bg-dark-mode-secondary text-light-mode-primary')}`}>
                    ...
                    <Link to="/case-study/extratime" className={`group flex items-center justify-center hover:bg-extratime card py-8 ${(mode == "light") ? ('bg-light-mode-secondary text-dark-mode-secondary') : ('bg-dark-mode-secondary text-light-mode-primary')}`}>
                         <div className='flex items-center justify-center flex-col pb-4 text-center'>
